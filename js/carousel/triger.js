        ...
        $(this).tab('show');
							...
							$(window).scroll(function() {
							  ...
							  if ($(this).scrollTop() > 200) {
								...
								$(".top-social3").fadeOut(1000); 
								//$(".top-social3").removeAttr("style");
							  } 
							   if ($(this).scrollTop() > 200) {
								//$("#nav-version7").css({"position": "fixed", "top": 0, "width": "100%","border-bottom":"1px solid #d2527f","background":"#d2527f"});
								toggleHeader();
								$("#nav-version7").css({"position": "fixed", "top": 0, "width": "100%","border-bottom":"1px solid #ffffff","background":"#ffffff"});
								$("#nav-version7").fadeIn(1000);   
							  } else {
								$("#nav-version7").fadeOut(2000); 
